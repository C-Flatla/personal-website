...
1.  **Requirements**
    - [Node.js](https://www.gatsbyjs.com/tutorial/part-zero/#install-nodejs-for-your-appropriate-operating-system)
    - [git](https://www.gatsbyjs.com/tutorial/part-zero/#install-git)
    - [Gatsby CLI](https://www.gatsbyjs.com/tutorial/part-zero/#install-git) `npm install -g gatsby-cli`

1.  **Installation**

    ```shell
    git clone git@github.com:C-Flatla/personal-website.git
    cd personal-website
    npm install
    ```
